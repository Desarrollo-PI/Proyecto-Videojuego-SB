...
export function WitchHat(props) {
  ...
  return (
    <group ref={groupRef} {...props} dispose={null}>
      ...
      <group>
        <group>
          <mesh geometry={nodes.Object_2.geometry} material={materials.gold} />
          <mesh geometry={nodes.Object_2_1.geometry} material={materials['cloth.001']} />
          <mesh geometry={nodes.Object_2_2.geometry} material={materials['Material.007']} />
        </group>
      </group>
      </RigidBody>
    </group>
