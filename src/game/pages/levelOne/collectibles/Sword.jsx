...
export function Sword(props) {
  ...
  return (
    <group ref={groupRef} {...props} dispose={null}>
        ...
        <group>
          <group>
            <mesh geometry={nodes.Sword_1.geometry} material={materials['Material.001']} />
            <mesh geometry={nodes.Sword_2.geometry} material={materials['mango.001']} />
            <mesh geometry={nodes.Sword_3.geometry} material={materials.material} />
          </group>
        </group>
        </RigidBody>
    </group>
