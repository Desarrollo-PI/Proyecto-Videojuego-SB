...
const withPhysics = (Component) => (props) => {
  const ref = useRef()
  return (<RigidBody ref={ref} {...props} type='fixed'><Component {...props} /></RigidBody>)
}

export default function WorldLevelOne(props) {
  const { nodes, materials } = useGLTF('/assets/models/worldLevelOne//LevelOneDraft600AALL.glb')
  return (
    <group {...props} dispose={null}>
      ...
      />
      <mesh castShadow receiveShadow geometry={nodes.Roof.geometry} material={materials.Material} />
      <mesh
        castShadow
        receiveShadow
      ...
      />
      <mesh castShadow receiveShadow geometry={nodes.Trees_1.geometry} material={materials.look} />
      <mesh
        castShadow
        receiveShadow
      ...
      <mesh
        ...
        material={materials.light}
      />
      <mesh castShadow receiveShadow geometry={nodes.Lamps_1.geometry} material={materials.foco} />
      <mesh
        castShadow
        receiveShadow
...
export const WorldLevelOneWithPhysisc = withPhysics(WorldLevelOne)
