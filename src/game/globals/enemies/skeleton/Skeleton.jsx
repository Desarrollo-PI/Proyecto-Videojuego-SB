...
export function Skeleton(props) {
  ...
  useFrame(({ clock }, delta) => {
    if (skeletonBody.current) {
      ...
      if (props.action == 0) {
        ...
        skeletonBody.current.setLinvel({ x: velocity.x, y: velocity.y, z: velocity.z }, true)
      }
  ...
  return (
    <RigidBody ref={skeletonBody} position={props.position} type="dynamic" colliders={false}>
      <group
        ref={skeletonRef}
        {...props}
        dispose={null}
