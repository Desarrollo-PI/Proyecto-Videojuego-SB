...
export default function Player({ isPlayerDeath = false }) {
  ...
  useFrame(() => {
    if (avatar.animation == "Attacking" && (actions['Attacking'].time >= 1.5) && !player.spellExpelliarmus) {
      setPlayer({ ...player, spellExpelliarmus: true, expelliarmusInitPosition: [0,1,0] })
    }
