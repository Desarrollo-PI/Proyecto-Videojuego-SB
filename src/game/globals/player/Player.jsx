...
export default function Player() {
	...
	return (
		<group ref={playerRef} name="Scene" scale={[0.7, 0.7, 0.7]} position={[0, -0.9, 0]}>
			<group
				name="Auror"
				...
				<group
					...
					scale={0.792}>
					<mesh name="Wand_1" geometry={nodes.Wand_1.geometry} material={materials.mat19} />
					<mesh name="Wand_2" geometry={nodes.Wand_2.geometry} material={materials.mat20} />
				</group>
